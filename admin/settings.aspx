<%@ Page Title="" Language="C#" MasterPageFile="~/themes/mundane/master.master" AutoEventWireup="true" Inherits="mynx.admin.settings" ValidateRequest="false" Codebehind="settings.aspx.cs" %>
